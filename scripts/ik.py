...
def main():
    ...
    # Double Pendulum
    # physics = mujoco.Physics.from_xml_path("/home/kallrax/Robotics/MedicalRobotics/dvrk_ws/src/dvrk_psm/mgcf/doublependulum.xml")
    ...
    print(qpos_from_site_pose(physics=physics,site_name=site,target_pos=target_pos,target_quat=target_quat,tol=tol))
